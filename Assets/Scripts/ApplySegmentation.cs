...
public class ApplySegmentation : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        segmentDict.Add("Floor", new Color32(207, 185, 151, 255));
        ...
        segmentDict.Add("DeletedObject", new Color32(244, 243, 239, 255));
        segmentDict.Add("AugmentedObject", new Color32(0, 255, 0, 255));
